...
export default function Card({ key, title, value, description }) {
  ...
  return (
    <div
      key={key}
      className="bg-white p-2 sm:p-6 rounded-2xl border border-gray-100 shadow-[0_8px_20px_rgba(0,0,0,0.08)] w-40 sm:w-54 2xl:w-74 hover:shadow-[0_12px_30px_rgba(0,0,0,0.12)] transition-all duration-300 font-['Poppins']"
    >
      {/* Title */}
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-2xl sm:text-3xl font-extrabold text-gray-900 drop-shadow-sm">
          {value}
        </span>
      </div>
